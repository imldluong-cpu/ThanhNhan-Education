    ...
    render() {
        ...
        sidebar.innerHTML = `
            <div class="sidebar-brand">
                <div class="sidebar-brand-icon" style="background: white; padding: 4px; border-radius: 6px; width: 36px; height: 36px; display: flex; justify-content: center; align-items: center;">
